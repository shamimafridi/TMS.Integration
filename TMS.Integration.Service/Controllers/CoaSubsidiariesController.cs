...
{
    public class CoaSubsidiariesController : ApiController
    {
        // GET: api/COAs
        private readonly CoaSubsidiaryPostService _service;
        public CoaSubsidiariesController(CoaSubsidiaryPostService service)
        {
            _service = service;
        }
